@php
    $header_user = Auth::guard('marriage_bureau')->user();
@endphp
        ...
        <div class="main-wrapper">
            ...
            <nav class="navbar navbar-expand-lg main-navbar px-3 py-2">
                ...
                @include('partials.panel-user-dropdown', [
                    'profileRoute' => route('marriage-bureau.profile.edit'),
                    'logoutRoute' => route('marriage-bureau.logout'),
                    'userName' => $header_user?->name ?? 'Bureau',
                    'userImage' => $header_user?->image ?? null,
                ])
            </nav>

            @include('marriage_bureau.sidebar')
